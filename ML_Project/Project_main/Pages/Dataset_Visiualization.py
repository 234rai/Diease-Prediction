...
# Main Visualization Logic
desktop_path = os.path.join(os.path.expanduser('~'), 'Desktop')
dataset_folder = os.path.join(desktop_path, "Disease_Dataset")  # Changed to Disease_Dataset

if not os.path.exists(dataset_folder):
    st.warning("No datasets found at ~/Desktop/Disease_Dataset. Please upload a dataset using uploaddata.py.")
    st.stop()
